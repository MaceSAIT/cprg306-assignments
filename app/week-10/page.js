    ...
    if (user){
        ...
        return (
            <div className='flex flex-col justify-center w-auto pt-20'>
                ...
                <Link className="p-4 m-4 border rounded-lg bg-gray-900 text-center mx-auto text-lg text-gray-200 font-semibold text-center" href={{pathname:'/week-10/shopping-list'}}>Open Page</Link>
